...
foreach ($required in @('1 item needs your attention.','Your lineup recommendation is out of date','Refresh Lineup','No waiver move proven','No active trade decision','View decision details','Evidence used','What changed','Saved decision','Butler is read only.')) {
