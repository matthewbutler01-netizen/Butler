...
try {
    ...
    foreach ($required in @(
        ...
        'scripts/butler-setup-launch.ps1',
        'scripts/butler-setup-runner.ps1',
        'scripts/butler-setup-process.ps1',
        'scripts/butler-setup-stop.cmd',
        'scripts/butler-setup-stop.ps1',
