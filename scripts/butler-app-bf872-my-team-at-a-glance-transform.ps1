...
<div class="button-row team-primary-actions"><a class="btn btn-primary" href="/matchup">Review Matchup</a><a class="btn btn-secondary" href="/matchup/autofill">Review Lineup</a></div><p class="meta team-action-note">Lineup projections are requested only after you choose Review Lineup. My Team remains passive and read only.</p>
