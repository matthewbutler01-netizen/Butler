...
<section class="panel boundary"><span class="lock">READ ONLY &middot; NOT A RANKING.</span> Waiver Board shows the governed BF-616 shortlist and, when exact BF-623/BF-631/BF-603/BF-602 reconciliation passes, identifies Butler's already-audited current ADD and its exact paired audited DROP. It does not rerank candidates, weight market/depth/injury, score newcomers, pick a new winner/drop, set FAAB, run BF-641, refresh evidence, or submit a Sleeper transaction.</section>
</main></body></html>
"@
}
