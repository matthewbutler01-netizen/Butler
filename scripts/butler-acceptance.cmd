...
echo BF-743 default: shared persistent workers preinitialize database schema once while preserving fresh reads and BF-623 verification; warmup-only opt-out is BUTLER_APP_WORKER_DATABASE_WARMUP=0; full worker opt-out remains BUTLER_APP_PERSISTENT_CORE_WORKER=0.
