...
/** Exact provider matchup identity for one team in one league-season week. */
public record TeamWeekMatchupEvidence(
    ...
    public TeamWeekMatchupEvidence {
        ...
        if (providerMatchupId <= 0) {
            throw new IllegalArgumentException("providerMatchupId must be positive");
        }
