...
public final class SleeperCounterTradeOutcomeCoordinator {
    ...
    public void initialize() throws SQLException {
        ...
        try (var connection = database.openConnection(); var statement = connection.createStatement()) {
            ...
            // BF-396 originally guards terminalization/consumption through executor outcomes only.
            // BF-410 extends those same database-level guards without pretending readback was an executor result.
            statement.executeUpdate("DROP TRIGGER IF EXISTS trg_trade_counter_execution_terminal_outcome_required");
            statement.executeUpdate("""
            ...
            statement.executeUpdate("DROP TRIGGER IF EXISTS trg_trade_counter_execution_claimed_grant_consumption_guard");
            statement.executeUpdate("""
