...
public final class ButlerCommandRouter {
    ...
    static Route route(String[] args) {
        if (args != null && args.length >= 2) {
            ...
            if (equals(args[0], "aging-model") && equals(args[1], "publication-validation")) {
                return Route.AGING_MODEL_PUBLICATION_VALIDATION;
            }
            ...
            if (equals(args[0], "aging-model") && equals(args[1], "position-age-coverage")) {
                return Route.AGING_MODEL_POSITION_AGE_COVERAGE;
            }
    ...
    enum Route { AGE_CONTEXT, AGE_PRODUCTION_CONTEXT, LEAGUE_AGING_MODEL_EVIDENCE, LEAGUE_AGE_OUTLOOK,
                 LEAGUE_SUPPORTING_EVIDENCE, TRADE_SUPPORTING_EVIDENCE, PLAYER_EVIDENCE_PROFILE,
                 LONGITUDINAL_EVIDENCE, AGING_MODEL_UNIVERSE,
