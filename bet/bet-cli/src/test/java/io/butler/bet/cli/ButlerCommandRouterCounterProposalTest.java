...
class ButlerCommandRouterCounterProposalTest {
    @Test
    void routesCounterProposalSeparatelyFromEvidenceDecisionAndRecommendation() {
        assertEquals(
            ButlerCommandRouter.Route.TRADE_COUNTER_PROPOSAL,
            ButlerCommandRouter.route(new String[]{
                "trade", "counter-proposal", "l1", "2026", "p1", "p2", "side-a"}));
        assertEquals(
            ButlerCommandRouter.Route.TRADE_COUNTER_DECISION,
            ButlerCommandRouter.route(new String[]{
