...
class ButlerLeagueSeasonLineupPointsGapEvidenceCliTest {
    ...
    @Test
    void rendersNeutralTeamOrderNflverseLaneSeparateDenominatorsAndNoCrossTeamComparison() throws Exception {
        ...
        String output = render(new LeagueSeasonLineupPointsGapEvidenceAnalyzer(database).analyze("l1", 2026));
    ...
    @Test
    void rendersProviderNativeLeagueLaneWithExactNestedTeamTotalsAndNoRanking() throws Exception {
        Database database = providerDatabase("league-season-provider-cli.db");
        ...
        assertTrue(output.contains("Team One [t1]"));
    ...
    private Database providerDatabase(String fileName) throws Exception {
    ...
    private static ProviderPlayerWeekPointsEvidence providerPoints(String providerPlayerId, BigDecimal points) {
    ...
    private static String render(LeagueSeasonLineupPointsGapEvidenceAnalyzer.LeagueEvidenceReport report) {
