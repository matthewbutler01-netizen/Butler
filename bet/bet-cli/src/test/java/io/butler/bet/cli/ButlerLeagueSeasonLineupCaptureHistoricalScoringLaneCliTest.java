...
class ButlerLeagueSeasonLineupCaptureHistoricalScoringLaneCliTest {
    @TempDir Path tempDir;

    @Test
    void rendersProviderNativeLeagueLaneProvenanceExactCaptureAndNeutralBoundary() throws Exception {
        Database database = new Database(tempDir.resolve("provider-league-capture-cli.db"));
        database.initialize();
