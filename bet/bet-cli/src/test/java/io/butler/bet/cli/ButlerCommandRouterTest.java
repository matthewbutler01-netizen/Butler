...
class ButlerCommandRouterTest {
    ...
    void routesSpecializedCommandFamiliesWithoutLauncherChaining() {
        ...
        assertEquals(ButlerCommandRouter.Route.LEAGUE_AGE_OUTLOOK,
            ButlerCommandRouter.route(new String[]{"league", "age-outlook", "l1", "2026"}));
        assertEquals(ButlerCommandRouter.Route.LEAGUE_SUPPORTING_EVIDENCE,
            ButlerCommandRouter.route(new String[]{"league", "supporting-evidence", "l1", "2026"}));
        ...
        assertEquals(ButlerCommandRouter.Route.TRADE_RECOMMENDATION,
            ButlerCommandRouter.route(new String[]{"trade", "recommendation", "l1", "2026", "p1", "p2", "side-a"}));
        ...
        assertEquals(ButlerCommandRouter.Route.LEAGUE_FRANCHISE_DETAIL,
            ButlerCommandRouter.route(new String[]{"league", "franchise-detail", "l1", "t1"}));
