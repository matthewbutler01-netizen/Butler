...
val sleeperLiveWaiverPregameEvidenceReadinessAudit by tasks.registering(JavaExec::class) {
    group = "application"
    description = "Read-only BF-609 classification of BF-608 pregame waiver candidates into evidence-readiness strata."
    classpath = sourceSets["main"].runtimeClasspath
...
val sleeperLiveWaiverTargetRosterProductionHydration by tasks.registering(JavaExec::class) {
    group = "application"
    description = "BF-612 guarded missing-only 2025 nflverse hydration for the exact BF-611 target roster."
    classpath = sourceSets["main"].runtimeClasspath
    mainClass.set("io.butler.bet.cli.ButlerSleeperLiveWaiverTargetRosterProductionHydrationCli")
}

val sleeperLiveWaiverCandidateRosterComparisonReadinessAudit by tasks.registering(JavaExec::class) {
    group = "application"
    description = "Read-only BF-613 same-frame candidate-vs-target-roster comparison-readiness authorization audit."
    classpath = sourceSets["main"].runtimeClasspath
...
val sleeperLiveWaiverRecommendationAuditCapture by tasks.registering(JavaExec::class) {
    group = "application"
...
val sleeperLiveWaiverRecommendationActionabilityRevalidation by tasks.registering(JavaExec::class) {
    group = "application"
    description = "Read-only BF-629 live roster actionability revalidation of the latest BF-628 integrity-verified governed recommendation audit."
    classpath = sourceSets["main"].runtimeClasspath
...
val sleeperLiveWaiverRecommendationEvidenceLineageRevalidation by tasks.registering(JavaExec::class) {
    group = "application"
    description = "Read-only BF-631 freshness revalidation of the latest governed audit against persisted BF-603/BF-602 evidence lineage."
    classpath = sourceSets["main"].runtimeClasspath
...
val sleeperCurrentWeekMatchupSync by tasks.registering(JavaExec::class) {
    group = "application"
    description = "BF-840 explicitly persists the current exact Sleeper matchup pairing without any Sleeper transaction write."
    classpath = sourceSets["main"].runtimeClasspath
    mainClass.set("io.butler.bet.cli.ButlerSleeperCurrentWeekMatchupSyncCli")
}
